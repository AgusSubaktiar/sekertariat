...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 13 Apr 2022 pada 05.00
...
(59, 4, '2022-04-10', '10/04/2022', 'Agus subak', 'Mletre bersama', '0101', 'Minum Amer Bersama', ''),
(60, 5, '2022-04-11', '11042022', 'Bapak Subak', 'Menata Proyek Mager', '9090', 'Proyek Mager', ''),
(61, 6, '2022-04-13', '0010', 'Bapak Subak', 'Memetik Buah dada', 'Proyek wikwik', 'Proyek bercocok tanam', '');
...
--
ALTER TABLE `terdisposisi`
  ADD CONSTRAINT `terdisposisi have surat masuk` FOREIGN KEY (`id_surat`) REFERENCES `suratmasuk` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `terdisposisi punya bidang` FOREIGN KEY (`id_bidang`) REFERENCES `nama_bidang_tb` (`id_bidang`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
